...
client = OpenAI(api_key="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")
...
db = dbclient['fund_data']
collectionr = db['fund_rate']
collections = db['fund_sector']
...
@app.route('/')
def index():
    return send_from_directory('public', '2_index.html')

# Route for handling chat messages
@app.route('/send-message', methods=['POST'])
def send_message():
    user_message = request.json.get('message')
    bot_response = chat_with_gpt(user_message, current_financial_data)
